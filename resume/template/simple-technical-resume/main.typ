...
#custom-title("Experience")[  
  ...
  #work-heading(
    ...
    - Developed and enforced company policies through the creation of the “Rozario Bucks” incentive program, improving employee engagement
  ...
  #work-heading(
    ...
    - Introduced “Rozario Bucks” as a motivational tool, fostering a competitive \& collaborative work environment
...
#custom-title("Projects")[
  #project-heading(
    "Rozario Farms (Bed and Breakfast)",
  )[
  ...
  #project-heading(
    "Gael Rozario's Gym for Muscles",
  )[
